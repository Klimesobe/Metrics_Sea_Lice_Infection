...
The resulting datasets were then use to visualize the location of each salmon farm on the map of Ireland. The farms monitores by the NSLMP and the Industry were plotted in two different figures. 
